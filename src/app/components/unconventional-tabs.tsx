...
export default function UnconventionalTabs({ tabs }: { tabs: Tab[] }) {
  ...
  return (
    <Tab.Group>
      {({ selectedIndex }) => (
        <div className={`${caveat.variable} text-white`}>
          {/* Buttons */}
          <div className="flex justify-center bg-slate-900">
            <Tab.List className="max-[480px]:max-w-[180px] inline-flex flex-wrap justify-center bg-gray-800 rounded-[20px] p-1 mb-8 min-[480px]:mb-12">
              {tabs.map((tab, index) => (
              ...
              {tabs.map((tab, index) => (
                <Tab.Panel key={index} as={Fragment} static={true}>
                  <Transition
                    ...
                    unmount={false}
                    className="w-full bg-gray-800 rounded-2xl shadow-xl min-[480px]:flex items-stretch focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300"
                  ...
                  >
                    ...
                    <div className="min-[480px]:w-1/2 flex flex-col justify-center p-5 pl-3">
                      <div className="flex justify-between mb-1">
                        ...
                        <button
                          className="shrink-0 h-[30px] w-[30px] border border-gray-700 hover:border-gray-600 rounded-full shadow inline-flex items-center justify-center focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 transition-colors duration-150 ease-in-out"
                          aria-label="Like"
                        >
                          <svg
                      ...
                      <div className="text-gray-400 text-sm line-clamp-3 mb-2">
                        {tab.excerpt}
                      </div>
